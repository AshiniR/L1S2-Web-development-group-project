...
<body>
    <div class="nav-bar">
        <a href="../index.php" class="nav-bar-logo"><img src="../images/logo/logo-b.png" alt="logo-white.png" width="180px" class="iconlogo"></a>
        ...
        <div class="nav-bar-icons">
            ...
            <button class="nav-bar-day" title="light mode">
