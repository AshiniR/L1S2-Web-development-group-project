...
<html>
    ...
    <body>
        <div class="header">
            <div class="head-nav">
                <div class="nav-bar">
                    <a href="" class="nav-bar-logo"><img src="images/logo/logo-w.png" alt="logo-white.png" width="180px"></a>
                    <a href="" class="nav-bar-links-everything">EVERYTHING</a>
                    <a href="" class="nav-bar-links">WOMEN</a>
                    <a href="" class="nav-bar-links">MEN</a>
                    <a href="" class="nav-bar-links">ACCESSORIES</a>
                    <a href="" class="nav-bar-links-about">ABOUT</a>
                    <a href="" class="nav-bar-links-contact">CONTACT US</a>
            ...
            <div class="head-content">
                ...
                <br><div class="head-second-text">40% Off For New Users!</div>
